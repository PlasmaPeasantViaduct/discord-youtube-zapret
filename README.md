...
# <img src="https://cdn-icons-png.flaticon.com/128/5968/5968756.png" height=28 /> <a href="https://github.com/PlasmaPeasantViaduct/discord-youtube-zapret">PlasmaPeasantViaduct/discord-youtube-zapret</a> <img src="https://cdn-icons-png.flaticon.com/128/1384/1384060.png" height=28 />

**Discord · YouTube · Telegram** — работает, когда «Connecting…» и тормоза  

Скачать актуальную сборку в [**Releases → DiscordFix**](https://github.com/PlasmaPeasantViaduct/discord-youtube-zapret/releases/tag/DiscordFix)
...
[Инструкция по установке и частые вопросы](https://plasmapeasantviaduct.github.io/discord-youtube-zapret/)
...
> Если вы наткнулись на что-то вне репозитория `PlasmaPeasantViaduct/discord-youtube-zapret`, что распространяется от моего лица - **ФЕЙК**.
...
2. Скачайте архив (zip/rar) со [страницы релиза DiscordFix](https://github.com/PlasmaPeasantViaduct/discord-youtube-zapret/releases/tag/DiscordFix)
...
Если этого не произошло, то см. [#522](https://github.com/PlasmaPeasantViaduct/discord-youtube-zapret/issues/522)
...
- См. [#765](https://github.com/PlasmaPeasantViaduct/discord-youtube-zapret/issues/765)
...
- Скачайте последнюю версию [со страницы релизов](https://github.com/PlasmaPeasantViaduct/discord-youtube-zapret/releases/tag/DiscordFix) (`zapret-discord-youtube-DiscordFix.rar` / `zapret-discord-youtube-DiscordFix.zip`)
...
- См. также [#251](https://github.com/PlasmaPeasantViaduct/discord-youtube-zapret/discussions/251)
...
- См. также [#252](https://github.com/PlasmaPeasantViaduct/discord-youtube-zapret/discussions/252)
...
Если и это не помогло, создайте ветку обсуждений в разделе [Discussions](https://github.com/PlasmaPeasantViaduct/discord-youtube-zapret/discussions) (не в issues) и ждите помощи от других игроков.

### Не нашли своей проблемы

- Создайте её [тут](https://github.com/PlasmaPeasantViaduct/discord-youtube-zapret/issues)
...
Проект распространяется на условиях лицензии [MIT](https://github.com/PlasmaPeasantViaduct/discord-youtube-zapret/blob/main/LICENSE.txt)
